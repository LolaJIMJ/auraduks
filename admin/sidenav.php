...
<head>
  <title>Auraduks - AdminDashboard</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
  ...
  -->
      ...
      <div class="sidebar-wrapper ps-container ps-theme-default" data-ps-id="3a8db1f4-24d8-4dbf-85c9-4f5215c1b29a">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="addshippingcost.php">
              <i class="material-icons">add</i>
              <p>Shipping Cost</p>
            </a>
          </li>
          ...
          <li class="nav-item ">
            <a class="nav-link" href="admin_logout.php" onClick="return confirm('Are you sure you want to log out?')">
